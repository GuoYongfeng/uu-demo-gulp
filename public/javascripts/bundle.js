...
var MessageList = React.createClass({displayName: "MessageList",  
  render: function() {
    return React.createElement("a", {href: this.state.url}, 
				React.createElement("ul", {class: "list"}, 
					React.createElement("li", {class: "title"}, 
						React.createElement("span", null, this.state.name), 
						React.createElement("span", {class: "fr mr"}, this.state.detail)
					), 
					React.createElement("li", null, 
						React.createElement("span", null, this.state.options), 
						React.createElement("i", {class: "fr icon_dir"})
					), 
					React.createElement("li", null, 
						React.createElement("span", null, this.state.datetime), 
						React.createElement("i", {class: "fr mr"}, this.state.status)
					)
				)
			); 
  }
...
var React = require('react');
var MessageList = require('../component/list.jsx');
...
},{"../component/list.jsx":157,"react":156}]},{},[158]);
